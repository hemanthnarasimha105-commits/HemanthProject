    ...
    <div>
      ...
      {dealsActive && (
        ...
        >
          ...
          <div className="row g-4">
            {[
              { title: "Paneer Butter Masala", img: "/images/Paneer Butter Masala.png", price: "₹60" },
              { title: "Chicken Biryani", img: "/images/Chicken Biryani.png", price: "₹75" },
              { title: "Chocolate Ice Cream", img: "/images/Chocolate Ice Cream.png", price: "₹40" },
              { title: "Milk Soda", img: "/images/Milk Soda.png", price: "₹16" },
              { title: "Chocolate Cake Slice", img: "/images/Chocolate Cake Slice.png", price: "₹40" },
              { title: "Rose Milk", img: "/images/Rose Milk.png", price: "₹20" },
            ].map((deal, i) => (
              <motion.div
                key={i}
                variants={sectionVariant}
